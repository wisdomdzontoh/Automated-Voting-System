...
?>
    <div id="wrapper">
     ...
     <style>
      ...
      /* Style for the home button when hovered */
      .home-button:hover {
        background-color: #0062cc;
      }
    </style>
    <a href="http://evotingsystem.42web.io/admin/voters.php" class="home-button">View Voters</a>
    <a href="http://evotingsystem.42web.io/admin/canvassing.php" class="home-button">reports</a>
    <h1>Welcome to the voter registration portal</h1>
    <p>wisdom_dzontoh.</p>
